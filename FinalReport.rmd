...
This plot shows the most of the black people think the the Bigbang is false, and the white people are at about 50/50 with believing if it true or false. The other race has more people believing it's true.
...
The numerical results show that about 80% of Black people do not believe in the Bigbang theory and whites are 50/50 in believing and not believing. The other race has a difference between black an white. 
...
There is a significant difference between the value  of p on the chi squared test 
...
You can see the others are different than the blacks and the differnce betweent he blacks and whites.
